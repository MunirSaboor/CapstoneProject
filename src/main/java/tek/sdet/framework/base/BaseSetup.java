...
public class BaseSetup {
	// this class is parent class of all Def, Utilities and POM classes
	...
	public BaseSetup() {
		...
		try {
			...
			System.out.println("Faild for Load envrionment context. check possible file path error");
			e.printStackTrace();
			throw new RuntimeException("Faild for Load envrionment context with message " + e.getMessage());
		}
